...
export default class App extends Component {
  ...
  deleteItem = () => {
    this.setState(prevState => {
      return {
        arr: prevState.arr.filter((el, i) => {
          return prevState.selected.key != el.key;
        }),
        selected:null
      };
    });
  ...
  selectItem = key => {
    this.setState(prevState => {
      return {
        selected: prevState.arr.find(el => {
          return el.key == key;
        })
      };
    });
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.inputContainer}>
          ...
          />
          <Button title="Add" style={styles.btn} onPress={this.btnHandler} />
        </View>
        <List values={this.state.arr} selectItem={this.selectItem} />
      </View>
    );
  }
}
